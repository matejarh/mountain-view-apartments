...
const bgImage = ref(new URL('/resources/images/backgrounds/cover-01.png', import.meta.url))
</script>
...
<template>
    <div
        ...
        <div class="relative z-20 h-35 md:h-65">
            <img :src="bgImage" alt="profile cover"
        ...
        <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div class="mt-4">
                ...
                <p class="font-medium">{{ $page.props.user.email }}</p>
                <div
                    ...
                    <div
                        ...
                        <span class="text-sm">{{__('Reviews')}}</span>
                    </div>
                    <div
                        class="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                    ...
                    <div class="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                        ...
                        <span class="text-sm">{{__('Reservations')}}</span>
                    </div>
                </div>
