...
<template>
    <li>
        <div class="bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden p-0 mx-auto max-w-screen-xl grid xl:grid-cols-2 gap-8 xl:gap-16">
        <div class="flex flex-col justify-center p-8">
            <h1
                ...
                <div class="mt-0 sm:items-center sm:gap-4 sm:flex">
                    ...
                    <div class="mt-0 grid grid-cols-1 sm:grid-cols-2 gap-2">
                        <div class="flex space-x-2 items-center" v-for="type, key in property.bed_types"
                            :key="key">
            ...
            <div class="mb-8 mt-4 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400" v-html="property.description[$page.props.locale]"></div>
        ...
        <div v-if="property.galleries.length > 0">
            <Carousel rounded="" :items="property.galleries[0].images" height="h-64 sm:h-[34rem] md:h-[33rem] lg:h-[20rem] xl:h-[27rem]"
