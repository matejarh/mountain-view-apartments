...
<template>
    ...
    <div class="" v-else>
        <Alert>
            ...
            <p>
                You can go to <inertia-link :href="route('properties.reviews.index', { property: $page.props?.property, lang: $page.props?.locale })" class="font-semibold underline hover:no-underline">reviews</inertia-link> for {{ $page.props?.property.title[$page.props?.locale] }}
