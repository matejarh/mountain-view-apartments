    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <div class="inline-flex items-center justify-items-center w-full px-4 py-2 font-semibold leading-6 text-sm  transition ease-in-out duration-150 cursor-not-allowed" v-else>
                    <svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-gray-900 dark:text-white" xmlns="http://www.w3.org/2000/svg"
