...
import AccomodationCarousel from '@/Components/_default/Welcome/AccomodationsCarousel.vue';
...
<template>
    <AnimatedLayout min-height="md:min-h-[515px]" :delay="100"
        ...
        <section class="relative bg-white dark:bg-gray-900 py-6 md:py-12">
            ...
            <ShapeTop
                class="absolute -scale-x-100 inset-y-full z-10 left-0 right-0 w-full bottom-1/2 text-white dark:text-gray-900 " />
        </section>
    </AnimatedLayout>
</template>
