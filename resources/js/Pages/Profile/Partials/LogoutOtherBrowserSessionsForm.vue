        ...
        <template #content>
            ...
            <div v-if="sessions.length > 0" class="mt-5 space-y-6">
                <div v-for="(session, i) in sessions" :key="i" class="flex items-center">
                    <div>
                        <svg v-if="session.agent.is_desktop" class="w-8 h-8 text-gray-500 dark:text-gray-400"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0115 18.257V17.25m6-12V15a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 15V5.25m18 0A2.25 2.25 0 0018.75 3H5.25A2.25 2.25 0 003 5.25m18 0V12a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 12V5.25" />
                        </svg>
                        <svg v-else-if="session.agent.is_tablet" class="w-8 h-8 text-gray-500 dark:text-gray-400"
                        ...
                        <svg v-else class="w-8 h-8 text-gray-500 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="ms-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500 dark:text-gray-200">
                                ...
                                <span v-if="session.is_current_device" class="text-amazon-500 font-semibold">{{ __('This device')}}</span>
            ...
            <div class="flex items-center mt-5">
                <PrimaryButton @click="confirmLogout">
                    <div class="flex items-center">
                        ...
                        {{ form.processing ? __('Logging Out Other Sessions') + '...' : form.recentlySuccessful ? __('Other sessions are logged out') :
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        <TextInput ref="passwordInput" v-model="form.password" type="password" class="mt-1 block w-3/4"
                            ...
                            :has-error="!!form.errors.password" @keyup.enter="logoutOtherBrowserSessions" />
