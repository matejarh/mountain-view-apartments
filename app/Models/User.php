...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    {
        return "https://api.dicebear.com/8.x/avataaars/svg?seed=" . urlencode("$this->name $this->email $this->phone"); // icons | pixel-art | ident ...  check https://www.dicebear.com/styles/
    }
