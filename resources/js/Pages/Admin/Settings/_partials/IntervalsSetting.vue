...
const newSetting = ref({
    ...
    description: 'Set up intervals for autoplaying and autoscrolling elements',
    attributes: {
        hero_background_interval: 10, // in seconds
    }
})
                ...
                <div v-else class="grid grid-cols-1 gap-4">
                    ...
                    <form>
                        <div class="mt-3" v-for="attribute, key in form?.attributes" :key="key">
                            ...
                            <TextInput :id="key" v-model="form.attributes[key]" type="number" min="1" max="60" step="1"
