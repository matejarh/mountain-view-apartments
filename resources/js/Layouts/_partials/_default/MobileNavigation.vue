...
/**
 * Determens id icons backgrounds should be shown
 */
    ...
    <div class=" xl:hidden fixed top-0 left-0 z-50 w-full p-4 bg-transparent flex justify-between">
        ...
        <teleport to="body">
            ...
            <div id="drawer-mobile"
                ...
                <div class="grow  overflow-y-auto scrollbar-thin flex flex-col justify-between">
                    <div class="px-4 relative">
                        <div class="">
                            <div class="pb-4  flex flex-col justify-between ">
                                <div v-if="$page.props?.auth.user"
                                    class="pt-4 mt-4 space-y-2 font-medium ">
