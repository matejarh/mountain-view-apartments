                            ...
                            @if (is_array($element))
                                @foreach ($element as $page => $url)
                                    @if ($page == $paginator->currentPage())
                                        <span
                                            class="flex items-center justify-center text-sm z-10 py-2 px-3 leading-tight text-white bg-primary-600 border border-primary-700 hover:bg-primary-600 hover:text-white dark:border-gray-700 dark:bg-gray-700 dark:text-white">
                                            {{ $page }}</span>
                                    @else
                                        <li>
