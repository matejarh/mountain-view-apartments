...
<template>
    <article class="block">
        <div class="py-8 px-4 mx-auto max-w-screen-xl xl:py-16 grid xl:grid-cols-2 gap-8">
            <div class="h-full flex flex-col justify-center">
                ...
                <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 mb-4">
            ...
            <div v-if="accomodation.galleries.length > 0">
                <CarouselGallery class=""  :items="accomodation.galleries[0].images" />
                <!-- <Carousel rounded="rounded-lg" :items="accomodation.galleries[0].images"
                    width=""  /> -->
